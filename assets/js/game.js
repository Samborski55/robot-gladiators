...
var endGame = function() {
    ...
    if (playerInfo.health > 0) {
        window.alert("Great job, you've survived the game! You now have a score of " + (playerInfo.money + playerInfo.health) + ".");
    }
    else {
...
var playerInfo = {
    ...
    upgradeAttack: function() {
        if (this.money >= 7) {
            windoow.alert("Upgrading player's attack by 6 for 7 dollars.");
            this.attack += 6;
            this.money -= 7;
        }
        else {
